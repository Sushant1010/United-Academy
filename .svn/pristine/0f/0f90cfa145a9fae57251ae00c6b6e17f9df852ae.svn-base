...
{
    [CustomAuthorize]
    public class KVendorController : Controller
    {
        private KVendorRepo db = new KVendorRepo();
        ...
        public ActionResult Index()
        {
            ...
            return View(db.GetKVendorList(orgid,""));
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            var aCD_Class = db.GetKVendorById((int)id);
            if (aCD_Class == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create(FormCollection frm)
        {
            var ses = sesrepo.GetSessionById((User as CustomPrincipal).UserId);
            int orgid = ses.OrganizationId;
            K_Vendor aCD_Class = new K_Vendor();
        ...
        public ActionResult Edit(FormCollection frm)
        {
            var ses = sesrepo.GetSessionById((User as CustomPrincipal).UserId);
            int orgid = ses.OrganizationId;
            K_Vendor aCD_Class = db.GetKVendorById(Convert.ToInt32(frm["VendorId"]));
            aCD_Class.VendorName = frm["VendorName"];
            aCD_Class.Address = frm["Address"];
            aCD_Class.Phone = frm["Phone"];
            aCD_Class.Mobile = frm["Mobile"];
        ...
        public ActionResult Delete(int? id)
        {
            ...
            var result = db.DeleteKVendor((int)id, (User as CustomPrincipal).UserId, DateTime.Now);
            //if (aCD_Class == null)
            //{
            //    return HttpNotFound();
            //}
